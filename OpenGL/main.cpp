...
int main() {
	...
	glShaderSource(vertexShader, 1, &vertexShaderSource, NULL); //(shader obj, # of strings of source code, actual source code, NULL)
	...
	unsigned int fragmentShader = glCreateShader(GL_FRAGMENT_SHADER); //Fragment Shader - Calc color output
